...
export const generate = (
  ...
  if (timeCubeItem.format === "life") {
    ...
    const cubeDuration = adjustDuration(timeCubeItem, dispatch, totalTime);
    ...
    // dispatch({ type: "SET_FIELD", field: "endDate", value: endDate });
    // dispatch({ type: "SET_FIELD", field: "initialDate", value: initialDate });
    // dispatch({ type: "SET_FIELD", field: "totalCubes", value: totalCubes });
    // dispatch({
    //   type: "SET_FIELD",
    //   field: "filledCubes",
    //   value: filledCubes,
    ...
    //   timeCubeItem.initialCustomDate.getFullYear(),
    //   timeCubeItem.initialCustomDate.getMonth(),
    //   timeCubeItem.initialCustomDate.getDate()
    // );
    // const endDate = new Date(
    //   timeCubeItem.endCustomDate.getFullYear(),
    //   timeCubeItem.endCustomDate.getMonth(),
    //   timeCubeItem.endCustomDate.getDate(),
    //   23,
    //   59,
    //   59,
    //   999
...
const adjustDuration = (
  ...
  if (Math.round(totalTime / (tempDuration * CONSTANT)) > MAX_SIZE) {
    ...
    //     : durationOptions[0].value,
    // });
    // dispatch({ type: "SET_FIELD", field: "error", value: true });
    dispatch({
      type: "UPDATE",
      payload: {
        id: timeCubeItem.id,
...
const finalCheck = (
  ...
  if (
    ...
    // dispatch({ type: "SET_FIELD", field: "endDate", value: endDate });
    // dispatch({ type: "SET_FIELD", field: "initialDate", value: initialDate });
    // dispatch({ type: "SET_FIELD", field: "totalCubes", value: 0 });
    // dispatch({ type: "SET_FIELD", field: "filledCubes", value: 0 });
    dispatch({
      type: "UPDATE",
      payload: {
        id: id,
